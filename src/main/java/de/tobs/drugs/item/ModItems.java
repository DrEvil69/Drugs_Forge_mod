...
public class ModItems {
    ...
    public static final RegistryObject<Item> BLUNT = ITEMS.register("blunt", () -> new Item(new Item.Properties().tab(ModTab.DRUGS_TAB).food(new FoodProperties.Builder().saturationMod(0).effect(()-> new MobEffectInstance(ModEffects.CANNABIS_HIGH.get(), 6000, 0), 1.0F).build())));
    public static final RegistryObject<Item> COCAIN = ITEMS.register("cocain", () -> new Item(new Item.Properties().tab(ModTab.DRUGS_TAB).food(new FoodProperties.Builder().saturationMod(0).effect(()-> new MobEffectInstance(ModEffects.COCAIN_HIGH.get(), 6000, 0), 1.0F).build())));
